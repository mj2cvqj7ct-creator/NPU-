...
from .services import ServiceProfile, get_service_profile
...
class EnhancementPipeline:
    ...
    service_profile: ServiceProfile = field(default_factory=get_service_profile)
    ...
    def process_frame(self, frame: AudioFrame) -> AudioFrame:
        ...
        controls = merge_controls(base_controls, inferred_controls, mix)
        controls = self.service_profile.apply(controls, features)
