...
class EnhancementPipeline:
    ...
    service_profile: ServiceEnhancementProfile = field(default_factory=get_service_profile)
    npu_mix: float = 0.35
    ...
    def process_frame(self, frame: AudioFrame) -> AudioFrame:
        ...
        controls = self.service_profile.apply(merge_controls(base_controls, inferred_controls, self.npu_mix))
