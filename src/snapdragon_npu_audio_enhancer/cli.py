...
from .service_profiles import MusicService, get_service_profile
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--target-lufs",
        type=float,
        help="Override the service profile's target RMS level in dBFS.",
    )
    ...
    parser.add_argument(
        ...
        help="Bias DSP/NPU controls for the selected music-service output.",
    )
    return parser
...
def main() -> None:
    ...
    print(
        ...
        f"with {backend_name}/{profile.service.value}; "
